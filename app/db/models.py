...
class CollectedMarketData(Base):
    __tablename__ = "collected_market_data"
    __table_args__ = (UniqueConstraint("symbol", "timeframe", "timestamp", name="uq_collected_market_data_bar"),)
    ...
    source_used: Mapped[str | None] = mapped_column(String(64), nullable=True)
    backfilled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
...
class SchedulerState(Base):
    ...
    last_runtime_error_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    last_runtime_error: Mapped[str | None] = mapped_column(String(128), nullable=True)
    last_stale_data_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    last_stale_data_reason: Mapped[str | None] = mapped_column(String(128), nullable=True)
